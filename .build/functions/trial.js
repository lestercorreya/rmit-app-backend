...
module.exports.handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var code, data, url, certificate_id, email_id, user_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                url = "https://rmit-app.s3.ap-southeast-2.amazonaws.com/alex-g.jpg";
                certificate_id = "uq135790";
                ...
                return [4 /*yield*/, (0, bcrypt_1.hash)(user_1.password, 10)
                        .then(function (hash) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    user_1.password = hash;
                                    return [4 /*yield*/, prisma.user.create({ data: user_1 })];
                                case 1:
                                    _a.sent();
                                    code = 200;
                                    data = {
